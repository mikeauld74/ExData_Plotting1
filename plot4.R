...
par(mfrow = c(2, 2)) 
plot(datedata, gap, type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datedata, volt, type="l", xlab="datetime", ylab="Voltage")
...
plot(datedata, grp, type="l", xlab="datetime", ylab="Global_reactive_power")
